...
/// <summary>
/// Nguồn kết nối tới CSDL demo. Mọi truy cập dữ liệu của ứng dụng đều đi qua
...
public sealed class Db(IConfiguration cauHinh)
{
    private readonly string _chuoiKetNoi =
        cauHinh.GetConnectionString("Demo")
        ?? throw new InvalidOperationException("Thiếu chuỗi kết nối 'Demo' trong appsettings.json");
